...
class Elex_dynamic_pricing_plugin_Admin {
	...
	public function enqueue_scripts() {
		...
		// wp_enqueue_script($this->xa_dynamic_pricing_plugin . '_bootstrap.js', plugin_dir_url(__FILE__) . 'js/bootstrap.js', array('jquery'), $this->version, false);
