...
$customOptions      =isset($rules_option_array[$active_tab][sanitize_text_field($_REQUEST['edit'])])?$rules_option_array[$active_tab][sanitize_text_field($_REQUEST['edit'])]:array();
