...
<ul>
<strong>Multi Product Rules:</strong>
...
<ul>
<strong>Multi Category Rules:</strong>
...
1. Product Rules
2. Category Rules
3. Discount Rules List
4. Pricing Table
5. Generic Settings
6. Rules & Execution Order
...
== Changelog ==
= 2.2.5 =
* Made compatible with WooCommerce 10.0
...
= 2.1.8 =
* Made compatible with WooCommerce 9.5
* Corrected a vulnerability issue using Wordfence
* Optimized code to improve loading time
* Fixed an issue where the discount did not update when reducing the quantity
...
= 2.1.5 =
* Fixed action icon issue
* Made compatible with WordPress 6.6
* Made compatible with WooCommerce 9.1
...
= 2.1.3 =
* Enhanced Security Measures - Implemented additional security checks and validations to safeguard against potential vulnerabilities.

= 2.1.2 =
* Bug fix - Issue of flat discount with multiple products
* Made compatible with WooCommerce 8.6

= 2.1.1 =
* Made compatible with WordPress 6.4.3
...
* Bug Fixes - Fixed rules indexing issue
* Bug Fixes - Fixed Java Script compatibility issue
* Bug Fixes - Fixed Php warnings

= 2.0.0 =
* Improved UI/UX
* Made compatible with WordPress 6.3
* Made compatible with WooCommerce 8.0
